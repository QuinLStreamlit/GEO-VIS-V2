...
def plot_engineering_property_vs_depth(
    ...
    xlabel : str, optional
        Custom label for x-axis (property axis). If None, uses display property name.
        Example: 'Moisture Content (%)' instead of default column-based name.
        
    ylabel : str, optional
        Custom label for y-axis (depth axis). If None, uses depth column name.
        Example: 'Depth (mbgl)' instead of default column name.
    ...
    **Advanced styling with log scale:**
    >>> plot_engineering_property_vs_depth(df, 'Permeability_m_s',
    ...                                    use_log_scale=True,
    ...                                    property_name='Permeability',
    ...                                    xlim=(1e-10, 1e-3))
    
    **Save without displaying:**
    >>> plot_engineering_property_vs_depth(df, 'LL_%',
    ...                                    show_plot=False,
    ...
    x_label = xlabel if xlabel is not None else display_property_name
    y_label = ylabel if ylabel is not None else depth_col
